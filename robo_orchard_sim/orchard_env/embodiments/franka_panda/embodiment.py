...
"""Embodiment provider for the Franka Panda robot."""
...
class FrankaPandaEmbodiment(EmbodimentBase):
    """Franka Panda embodiment for single-arm manipulation tasks."""
    ...
    def _get_camera_assets() -> GroupAssetCfg:
        ...
        return GroupAssetCfg(**FrankaPandaEmbodiment._get_camera_asset_map())
    ...
    def __init__(
        ...
        super().__init__(
            robot=ArticulationSpec(
                name=name,
                namespace=namespace,
                template_cfg=FRANKA_PANDA_HIGH_PD_CFG,
