...
"""Canonical policy bindings for dual-arm Piper-style embodiments."""
...
def build_dualarm_piper_policy_binding_schema(
    embodiment_type: str,
) -> PolicyBindingSchema:
    """Build the shared dual-arm policy binding schema."""
