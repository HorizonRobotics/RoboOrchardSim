...
# Configuration of Franka Emika Panda robot with orchard interface
# insteard of isaac lab interface original franka config
# is from isaaclab_assets.robots.franka
FRANKA_PANDA_CFG = ArticulationCfg(
    prim_path="{ENV_REGEX_NS}/franka_panda",
    spawn=UsdFileCfg(
        usd_path=f"{NV_ISAACLAB_DIR}/Robots/FrankaEmika/panda_instanceable.usd",
