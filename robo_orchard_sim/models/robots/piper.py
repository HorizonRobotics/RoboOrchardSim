...
__all__ = ["PIPER_GRIPPER_CFG"]

urdf_spawn_cfg = UrdfFileCfg(
    asset_path=f"{ORCHARD_ASSET}/ROBOTS/mobile_aloha_sim-2.0.0/aloha_new_description/urdf/single_aloha_new_wo_material_color.urdf",
    usd_dir="/tmp/IsaacLab/single_piper/usd",
    usd_file_name="single_aloha_new_wo_material_color.usd",
    fix_base=True,
    merge_fixed_joints=False,
    collider_type="convex_decomposition",
    semantic_tags=[("class", "piper")],
...
PIPER_GRIPPER_CFG = ArticulationCfg(
    ...
    actuators=dict(
        ...
        gripper=ImplicitActuatorCfg(
            joint_names_expr=["fl_joint7", "fl_joint8"],
