...
def test_importing_evaluator_does_not_import_isaac_runtime(
    ...
    reloaded_modules = {
        "robo_orchard_sim.pipeline.evaluator",
        "robo_orchard_sim.pipeline.evaluator.base",
        "robo_orchard_sim.pipeline.evaluator.evaluator",
    }
    blocked_modules = {
        "robo_orchard_sim.ext.envs.env_base",
        "robo_orchard_sim.ext.envs.manager_based_env",
    ...
    try:
        module = importlib.import_module("robo_orchard_sim.pipeline.evaluator")
